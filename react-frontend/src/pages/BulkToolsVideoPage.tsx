...
export function BulkToolsVideoPage() {
  ...
  useEffect(() => {
    if (!isPending && !session) {
      navigate(signInUrl("/dashboard/bulk-tools/video"), { replace: true });
    }
  ...
  return (
    <>
      <BulkToolsVideoWithAccounts supportedPlatforms={Array.from(VIDEO_PLATFORMS)} />
      <a
