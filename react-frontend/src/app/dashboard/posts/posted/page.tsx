...
export default async function PostedPostsPage({
  ...
  if (!session) {
    return (
      <GuestPostsPageView
        pageTitle="Posted"
        pageDescription="Published posts"
        promptTitle="Sign in to see your posted content"
        promptDescription="Your published posts will appear here after you sign in."
      />
    );
  }
