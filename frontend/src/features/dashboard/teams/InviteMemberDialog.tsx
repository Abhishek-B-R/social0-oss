        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              disabled={busy}
              className="w-full rounded-xl border border-input bg-bg px-4 py-2.5 text-sm font-medium text-text focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20 disabled:opacity-60"
            >
