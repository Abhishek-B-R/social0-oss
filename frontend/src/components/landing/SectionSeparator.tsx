  ...
  return (
    ...
    >
      ...
      <div className="relative mx-3 flex items-center gap-2">
        <span className="h-2 w-2 rotate-45 rounded-[2px] border border-emerald-400/80 bg-emerald-500/30" />
        <span className="font-serif text-[11px] tracking-[0.2em] text-white/25">
          SOCIAL0
        </span>
        <span className="h-2 w-2 rotate-45 rounded-[2px] border border-emerald-400/80 bg-emerald-500/30" />
      </div>
