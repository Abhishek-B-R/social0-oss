 ...
 *  Colors use CSS variables so light/dark theme can recolor wireframes. */
...
/** Theme-aware palette via --iso-* CSS vars on .landing-page */
export const C = {
  bg: "var(--iso-bg)",
  surface: "var(--iso-surface)",
  elevated: "var(--iso-elevated)",
  panel: "var(--iso-panel)",
  muted: "var(--iso-muted)",
  mid: "var(--iso-mid)",
  stroke: "var(--iso-stroke)",
  strokeSoft: "var(--iso-stroke-soft)",
  strokeBright: "var(--iso-stroke-bright)",
  white: "var(--iso-ink)",
  ink: "var(--iso-ink)",
  inkInverse: "var(--iso-ink-inverse)",
