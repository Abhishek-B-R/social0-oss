export const API_OAUTH_SCOPES = {
  ...
  "analytics:read": "Read live post metrics for posts published through Social0.",
  "inbox:read": "Read comments and DMs for connected accounts.",
  "inbox:write": "Reply to, like, and hide comments, and send DM replies.",
